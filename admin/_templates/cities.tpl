			...
			<div class="list">
				...
				<div class="row {cycle values='odd,even'}" id="item{$city.id}">
					<div class="icons">
						...
						<a href="javascript:void(0);" title="Delete this city" onclick="jobberBase.deleteCity('{$BASE_URL_ADMIN}cities/delete/', {$city.id})"><img src="{$BASE_URL_ADMIN}_templates/img/icon-delete.png" alt="Delete" /></a>
					</div>
