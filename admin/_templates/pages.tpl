		...
		<div id="content">
			...
			{foreach from=$pages item=page}
				<div class="row {cycle values='odd,even'}">
					...
					<a href="{$BASE_URL_ADMIN}pages/delete/{$page.url}/" title="Delete this page" onclick="if(!confirm('Are you sure you want to delete this page?'))return false;"><img src="{$BASE_URL_ADMIN}_templates/img/icon-delete.png" alt="Delete" /></a>
					</div>
