<?php /* Smarty version 2.6.26, created on 2013-07-27 16:49:28
...
_templates/img/star_off.png" alt="activate" /></a>
			<?php else: ?>
...
);" title="Turn spotlight off"><img src="<?php echo $this->_tpl_vars['BASE_URL_ADMIN']; ?>
_templates/img/star_on.png" alt="deactivate" /></a>
			<?php endif; ?>&nbsp;
...
<?php endif; ?><?php if ($this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]): ?>,<span class="spam"> reported as spam <?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['numberOfSpamReports']; ?>
 times, last time on <?php echo $this->_tpl_vars['spamReportStatisticalData'][$this->_tpl_vars['job']['id']]['lastSpamReportOn']; ?>
</span><?php endif; ?></div>
	</div>
