							...
							<td><textarea {if $errors.description}class="error"{/if} tabindex="4" name="description" id="description" cols="80" rows="15">{if $job.company}{$job.description}{else}{$smarty.post.description}{/if}</textarea>
								...
								<div id="textile-suggestions" style="display: none;">
									<table>
											...
											<tbody>
											<tr class="even">
												<td>诚聘 _资深JAVA工程师_</td>
												<td>诚聘 <em>资深JAVA工程师</em></td>

											</tr>
											<tr class="odd">
												<td>*待遇*</td>
												<td><strong>待遇</strong></td>
											</tr>
											<tr class="even">
												<td>"公司网址":http://www.zhaotop.com</td>

												<td><a href="http://www.zhaotop.com">公司网址</a></td>
											</tr>
											{*<tr class="odd">*}
											...
											<tr class="odd">
												<td># 能够胜任搜索引擎核心技术的研究与开发<br /># 拥有2年以上搜索引擎开发和维护经验者, 有开源开发经验或有中大型互联网搜索引擎系统开发经验优先考虑<br /># 具有良好的逻辑分析、问题解决、学习、沟通和文字表达能力，勤奋敬业，较强的沟通协调和组织能力，具有良好的团队合作精神</td>
												<td>
													<ol>
														<li>能够胜任搜索引擎核心技术的研究与开发</li>
														<li>拥有2年以上搜索引擎开发和维护经验者, 有开源开发经验或有中大型互联网搜索引擎系统开发经验优先考虑</li>
														<li>具有良好的逻辑分析、问题解决、学习、沟通和文字表达能力，勤奋敬业，较强的沟通协调和组织能力，具有良好的团队合作精神</li>
													</ol>
												</td>
											</tr>
											</tbody>
