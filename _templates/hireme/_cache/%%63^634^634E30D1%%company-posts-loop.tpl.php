<?php /* Smarty version 2.6.26, created on 2012-11-23 06:09:54
         compiled from company-posts-loop.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'company-posts-loop.tpl', 13, false),)), $this); ?>
<!-- Jobs from the same company -->
<?php if (count ( $this->_tpl_vars['compjobs'] ) > 1): ?>
<h2><?php echo $this->_tpl_vars['translations']['jobs']['recent_jobs']; ?>
...
" />
					...
					<span class="date"><?php echo ((is_array($_tmp=$this->_tpl_vars['compjob']['created_on'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d %b") : smarty_modifier_date_format($_tmp, "%d %b")); ?>
</span>
					<span class="jobtitle"><?php echo $this->_tpl_vars['compjob']['title']; ?>
</span><br />
					<span class="company_name">
						<?php echo $this->_tpl_vars['compjob']['company']; ?>
, <br />
						<?php if ($this->_tpl_vars['compjob']['is_location_anywhere']): ?><?php echo $this->_tpl_vars['translations']['jobs']['location_anywhere']; ?>
<?php else: ?><?php echo $this->_tpl_vars['compjob']['location']; ?>
<?php endif; ?>
					</span>
				</a>
			</li>
