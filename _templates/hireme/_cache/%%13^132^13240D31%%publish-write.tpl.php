<?php /* Smarty version 2.6.26, created on 2012-11-23 06:10:03
...
"></div>
						...
						<tr>
							<td class="publish-label" valign="top"><?php echo $this->_tpl_vars['translations']['publish']['location_label']; ?>
:</td>
							<td>
...
"<?php endif; ?> />
						...
						<tr>
							<td class="publish-label" valign="top"><?php echo $this->_tpl_vars['translations']['publish']['description_label']; ?>
:</td>
...
/img/icon-delete.png" alt="" /><?php endif; ?></span>
						...
						<tr>
							<td class="publish-label" valign="top"><?php echo $this->_tpl_vars['translations']['publish']['website_label']; ?>
:</td>
